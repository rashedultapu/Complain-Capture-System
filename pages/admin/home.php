...
$result_set1=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."'");
$row1=mysql_fetch_assoc($result_set1);

$result_set2=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date5."' AND '".$end_date5."'");
$row2=mysql_fetch_assoc($result_set2);

$result_set3=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date1."' AND '".$end_date1."'");
$row3=mysql_fetch_assoc($result_set3);

$result_set4=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date2."' AND '".$end_date2."'");
$row4=mysql_fetch_assoc($result_set4);

$result_set5=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date3."' AND '".$end_date3."'");
$row5=mysql_fetch_assoc($result_set5);

$result_set6=mysql_query("SELECT count(problem_type) as total_complain FROM complains WHERE `submitted_date` BETWEEN '".$start_date4."' AND '".$end_date4."'");
$row6=mysql_fetch_assoc($result_set6);

//Open Complain

$result_set7=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."'");
$row7=mysql_fetch_assoc($result_set7);

$result_set8=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND  `submitted_date` BETWEEN '".$start_date5."' AND '".$end_date5."'");
$row8=mysql_fetch_assoc($result_set8);

$result_set9=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND  `submitted_date` BETWEEN '".$start_date1."' AND '".$end_date1."'");
$row9=mysql_fetch_assoc($result_set9);

$result_set10=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND  `submitted_date` BETWEEN '".$start_date2."' AND '".$end_date2."'");
$row10=mysql_fetch_assoc($result_set10);

$result_set11=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND  `submitted_date` BETWEEN '".$start_date3."' AND '".$end_date3."'");
$row11=mysql_fetch_assoc($result_set11);

$result_set12=mysql_query("SELECT count(problem_type) as open_complain FROM complains WHERE status = 'Open' AND  `submitted_date` BETWEEN '".$start_date4."' AND '".$end_date4."'");
$row12=mysql_fetch_assoc($result_set12);

$result_set13=mysql_query("SELECT count(problem_type) as monthly_solved_complain FROM complains WHERE status = 'Closed' AND  `submitted_date` BETWEEN '".$start_date1."' AND '".$end_date1."'");
$row13=mysql_fetch_assoc($result_set13);

$result_set14=mysql_query("SELECT count(problem_type) as daily_total_complain FROM complains WHERE `submitted_date` = '$daily'");
$row14=mysql_fetch_assoc($result_set14);

$result_set15=mysql_query("SELECT count(problem_type) as daily_solved_complain FROM complains WHERE status = 'Closed' AND  `submitted_date` = '$daily'");
