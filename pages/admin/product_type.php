...
if(isset($_POST['btn-save']))
{
  ...
  $sql_query = "INSERT INTO product (submitted_by,submitted_date,type) VALUES('$submitted_by','$submitted_date','$type')";
...
{
  $sql_query="DELETE FROM product WHERE user_id=".$_GET['delete_id'];
    ...
    function delete_id(id)
      {
        if(confirm('Are You Want To Delete This Problem Type ?'))
          {
             window.location.href='product_type.php?delete_id='+id;
          }
      }
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="product_type.php">Product Type</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Product Type</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form method="post" class="form-horizontal">
							...
							<div class="control-group warning">
								<label class="control-label" for="inputWarning">Product</label>
								<div class="controls" >
								  <input type="text" name="type" placeholder='Product' required>
								</div>
							</div>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table id="employee-grid" class="table table-striped table-bordered">
						  ...
						  <?php
                                $raw_results = mysql_query("SELECT * FROM `product` ORDER  BY `submitted_date` DESC");
