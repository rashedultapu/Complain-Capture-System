						...
						<table id="employee-grid" class="table table-striped table-bordered">
						  ...
						  <?php
                                    ...
                                    if (empty($_POST['start_date']) || empty($_POST['end_date']) || empty($_POST['cell'])) {
                                        ...
                                        $raw_results = mysql_query("SELECT * FROM `complains` WHERE `problem_sub_type` = '$expert' and  `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."' ORDER  BY `submitted_date` DESC");
                                        }
                                    else if (empty($_POST['start_date']) || empty($_POST['end_date'])) {

                                    	$cell = $_POST['cell'];

                                        $raw_results = mysql_query("SELECT * FROM `complains` WHERE `problem_sub_type` = '$expert' and `customer_number` LIKE '".$cell."' ORDER  BY `submitted_date` DESC");
                                        }
                                    else {
                                        ...
                                        $raw_results = mysql_query("SELECT * FROM `complains` WHERE `problem_sub_type` = '$expert' and `customer_number` LIKE '".$cell."' AND `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."' ORDER  BY `submitted_date` DESC"); 
                                        }
