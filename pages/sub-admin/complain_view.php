...
if(isset($_POST['btn-save']))
{
  ...
  $sql_query = "UPDATE complains SET status='$status',assigned_to='$assigned_to',assign_date='$assign_date' WHERE user_id=".$_GET['edit_id'];
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form method="post" class="form-horizontal">
							...
							<div class="control-group">
								<label class="control-label" for="inputWarning">Problem Title</label>
								<div class="controls">
									 <textarea name="problem_type" rows="3" readonly><?php echo $fetched_row['problem_title']; ?> </textarea>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputWarning">Problem Type</label>
								<div class="controls">
									<input type="text" name="problem_type" value="<?php echo $fetched_row['problem_sub_type']; ?>" readonly>
								</div>
							</div>
							<div class="control-group">
