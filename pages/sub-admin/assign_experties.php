...
if(isset($_POST['btn-save']))
{
  ...
  $sql_query = "UPDATE user_info SET expert_in='$expert' WHERE username='$username'";
  ...
  if(mysql_query($sql_query))
  {
    ...
    window.location.href='assign_experties.php';
    </script>
    <?php
  }
  else
  {
    ?>
    <script type="text/javascript">
    alert('Error Occured While Assigning Complain');
    </script>
    <?php
  }
}
...
{
  header("Location: assign_experties.php");
}
?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="box-content">
						<form method="post" class="form-horizontal">
							...
							<div class="control-group">
								<label class="control-label" for="selectError">Select Employee</label>
								<div class="controls">
								<select name="username" id="username" data-rel="chosen">
									<option value="">Employee List</option>
									<?php
                                              $query = mysql_query("SELECT * FROM `user_info` where user_type = 'Employee' and department = '$dept' AND  expert_in = ' '");
							...
							<div class="control-group">
								<label class="control-label" for="selectError">Select Area Of Expert</label>
								<div class="controls">
								<select name="expert" id="expert" data-rel="chosen">
									<option value="">Area Of Expert</option>
									<?php
                                              $query = mysql_query("SELECT DISTINCT sub_type FROM `problem` WHERE type = '$dept' ORDER BY `type`");
                                                while($row = mysql_fetch_array($query)){
							  ...
							  <div class="form-actions">
							  		<button type="submit" name="btn-save" class="btn btn-primary">Assign</button>
