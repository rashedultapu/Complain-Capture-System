	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="feedback_details.php">Feedback Details</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Feedback Details</h2>
						<div class="box-icon">
						  ...
						  <tbody>
                              <tr>
                                    ...
                                    <td>
									  <div class="control-group warning">
										<div class="controls" >
										  <input type="number" name="cell" placeholder='Customer Number'>
										</div>
									  </div>
									</td>
						...
						<table id="employee-grid" class="table table-striped table-bordered">
						  ...
						  <?php
                                    ...
                                    if (empty($_POST['start_date']) || empty($_POST['end_date']) || empty($_POST['cell'])) {
                                        ...
                                        $raw_results = mysql_query("SELECT * FROM `feedback` WHERE `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."' ORDER  BY `submitted_date` DESC");
                                        }
                                    else if (empty($_POST['start_date']) || empty($_POST['end_date'])) {

                                    	$cell = $_POST['cell'];

                                        $raw_results = mysql_query("SELECT * FROM `feedback` WHERE `customer_number` LIKE '".$cell."' ORDER  BY `submitted_date` DESC");
                                        }
                                    else {
                                        ...
                                        $raw_results = mysql_query("SELECT * FROM `feedback` WHERE `customer_number` LIKE '".$cell."' AND `submitted_date` BETWEEN '".$start_date."' AND '".$end_date."' ORDER  BY `submitted_date` DESC"); 
                                        }
						  ...
						  <tbody>
                              <tr>
                                    ...
                                    <td><?php echo $results['feedback']; ?></td>
                              </tr>
                          <?php
                               }
                                  }
