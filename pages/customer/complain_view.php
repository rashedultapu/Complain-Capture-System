...
if(isset($_POST['btn-save']))
{
  ...
  $sql_query = "UPDATE complains SET status='$status',closed_by='$uname',closed_date='$closed_date' WHERE user_id=".$_GET['edit_id'];
					...
					<div class="box-content">
						<form method="post" class="form-horizontal">
							...
							<div class="control-group">
							    ...
							    <span class="rating">
				                        <span class="star" type="submit" name="1" Value='1'></span><span class="star"  type="submit" name="2" Value='2'></span><span class="star"  type="submit" name="3" Value='3'></span><span class="star"  type="submit" name="4" Value='4'></span><span class="star"  type="submit" name="5" Value='5'></span>
				                    </span>
							</div>
